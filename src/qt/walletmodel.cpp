    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered bitcoin address / amount:
            ...
            if(termDepositLength>0){
                ...
                if(termDepositLength<=288*2){
                    ss <<"!!!!!WARNING: There is no interest rate advantage of using a Term Deposit for a period of less than 576 blocks. It is recommended that you cancel this transaction. ";
                }
                if(termDepositLength>288*365){
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        Q_FOREACH(const SendCoinsRecipient &rcp, transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal europecoin:URI (europecoin:123...?message=example)
