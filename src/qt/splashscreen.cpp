    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int paddingRight            = 225; //50
    int paddingTop              = 50; //50
    ...
    QString titleText       = tr("EuropeCoin Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString("2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin developers"));
    QString copyrightText2  = QChar(0xA9)+QString("2016 ").arg(COPYRIGHT_YEAR) + QString(tr("The EuropeCoin developers"));

    const char *inspirationals[] = {
        "Welcome by Euroecoin V3",
        "Welcome by Euroecoin V3",
        "Welcome by Euroecoin V3",
        "Welcome by Euroecoin V3",
        "Welcome by Euroecoin V3",
    ...
    pixPaint.setPen(QColor(0,0,139));
	...
	QRect rectIcon(QPoint(200,30), QSize(330,330));
...
static void InitMessage(SplashScreen *splash, const std::string &message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(0,0,128))); //Navy
 }
